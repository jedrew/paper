...
a brief restatement of the many features of the IPHAS survey in section 2).
...
them.  In section 5, the maps we are subjected to some first comparisons with Galactic 
model predictions.  This is attempted using more than one prescription of the 3-d 
...
paper ends in section 6 with a brief discussion and summary.
