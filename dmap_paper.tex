...
of both measured widths of the point spread function (PSF), and limiting magnitude (for full details, see \citet{Barentsen2014}).  This variation, along with over a factor of ten decline in the typical observed stellar density along the Northern 
Plane from $\ell \sim 30^{\circ}$ out to the Anticentre (see figure 3 in \citet{Gonzalez-Solares2008}), makes it important to 
